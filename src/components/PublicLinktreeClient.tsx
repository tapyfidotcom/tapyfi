          ...
          <div className="w-full max-w-md mx-auto">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4 w-full">
                {links.length > 0 ? (
                  links
                    .sort((a: LinktreeLink, b: LinktreeLink) => a.display_order - b.display_order)
                    .map((link: LinktreeLink) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`absolute inset-0 bg-gradient-to-r from-white/10 to-transparent opacity-0 transition-opacity duration-300 ${
