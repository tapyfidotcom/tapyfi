export const hyperspeedPresets = {
  ...
  three: {
    ...
    colors: {
      ...
      shoulderLines: 0x131318,
      brokenLines: 0x131318,
      leftCars: [0x7d0d1b, 0xa90519, 0xff102a] as number[],
      rightCars: [0xf1eece, 0xe6e2b1, 0xdfd98a] as number[],
      sticks: 0xf1eece,
    },
  },
  four: {
    ...
    colors: {
      ...
      shoulderLines: 0x131318,
      brokenLines: 0x131318,
      leftCars: [0xff5f73, 0xe74d60, 0xff102a] as number[],
      rightCars: [0xa4e3e6, 0x80d1d4, 0x53c2c6] as number[],
      sticks: 0xa4e3e6,
    },
  },
  five: {
    ...
    colors: {
      ...
      shoulderLines: 0x131318,
      brokenLines: 0x131318,
      leftCars: [0xdc5b20, 0xdca320, 0xdc2020] as number[],
      rightCars: [0x334bf7, 0xe5e6ed, 0xbfc6f3] as number[],
      sticks: 0xc5e8eb,
    },
  },
  six: {
    ...
    colors: {
      ...
      shoulderLines: 0x131318,
      brokenLines: 0x131318,
      leftCars: [0xff322f, 0xa33010, 0xa81508] as number[],
      rightCars: [0xfdfdf0, 0xf3dea0, 0xe2bb88] as number[],
      sticks: 0xfdfdf0,
    },
  },
} as const;
