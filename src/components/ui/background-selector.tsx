...
export default function BackgroundSelector({
  ...
  const renderAdvancedControls = () => {
    if (currentBackground.type !== 'hyperspeed') return null;
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <Input
              ...
              onChange={(e) => updateBackground({ roadWidth: parseFloat(e.target.value) })}
              className="flex-1"
            />
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <Input
              ...
              onChange={(e) => updateBackground({ lanesPerRoad: parseInt(e.target.value) })}
              className="flex-1"
            />
            <span className="text-xs w-12 text-center font-mono bg-muted px-2 py-1 rounded">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <Input
              ...
              onChange={(e) => updateBackground({ speedUp: parseFloat(e.target.value) })}
              className="flex-1"
            />
            <span className="text-xs w-12 text-center font-mono bg-muted px-2 py-1 rounded">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-2">
            <Input
              ...
              onChange={(e) => updateBackground({ totalSideLightSticks: parseInt(e.target.value) })}
              className="flex-1"
            />
            <span className="text-xs w-12 text-center font-mono bg-muted px-2 py-1 rounded">
        ...
        <div className="grid grid-cols-2 gap-4">
          {backgroundTypes.map((bg) => (
            <Button
              ...
              onClick={() => updateBackground({ type: bg.type as BackgroundSettings['type'] })}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              <span className="text-lg font-semibold relative z-10">{bg.name}</span>
              <span className="text-xs text-muted-foreground relative z-10">{bg.category}</span>
            </Button>
          ))}
        </div>
      </div>
            ...
            <>
              ...
              <div className="flex items-center gap-3">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => updateBackground({ mouseInteraction: checked })}
                />
              </div>
            </>
          )}
