      ...
      <div className="sticky top-6">
        <Card className="overflow-hidden dark:bg-gray-800 dark:border-gray-700 shadow-xl">
          ...
          <CardContent className="p-0">
            {/* Mobile Phone Frame */}
            <div className="mx-auto bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-4 m-6 shadow-2xl">
              {/* Phone Screen */}
              <div 
                ref={previewRef}
                key={`preview-${refreshKey}-${backgroundSettings.type}`}
                className="aspect-[9/16] max-w-[300px] mx-auto relative rounded-2xl overflow-hidden shadow-2xl border-4 border-gray-700 bg-white transition-opacity duration-200"
              >
                {/* iPhone-style Notch */}
                        ...
                        <>
                          {links.slice(0, 5).map((link) => {
                            ...
                            return (
                              <div
                                key={link.id}
                                className="text-sm p-4 rounded-xl flex items-center justify-between gap-3 font-medium transition-all duration-200 hover:scale-[1.02] cursor-pointer shadow-lg hover:shadow-xl backdrop-blur-sm"
                                style={{ 
                ...
                <div className="absolute bottom-3 right-3 text-xs text-white/90 bg-black/50 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/20">
